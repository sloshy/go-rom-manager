      ...
      <div class="tui-panel">
        ...
        <div class="panel-body">
          <p class="text-dim" style={{ margin: 0 }}>
            When a game has multiple variants, auto-select walks this list top to
            bottom. The first tag that matches at least one variant wins.
            Demo/Proto are always filtered out when alternatives exist; ties are
            broken by highest Rev.
          </p>
